...
if {[is_project_open]} {
	if {[string compare $quartus(project) "DE10_Nano_SoC"]} {
		puts "Project DE10_Nano_SoC is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists DE10_Nano_SoC]} {
		project_open -revision DE10_Nano_SoC DE10_Nano_SoC
	} else {
		project_new -revision DE10_Nano_SoC DE10_Nano_SoC
	}
